#!/usr/bin/env python3
"""
Process JSON Files Script with Enhanced Semantic Chunking
...
def main():
    ...
    parser.add_argument('--folder', required=True, help='Name of the folder to process')
    ...
    parser.add_argument('--image-urls', help='Path to JSON file with image URLs to include in webhook payload')
